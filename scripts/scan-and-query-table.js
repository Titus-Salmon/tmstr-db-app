...
app.post('/api/data', (request, response) => {
    ...
    //userDataCategory.push(Object.values(postBody)[0]); //pushes string entered in search box to userDataCategory array

//console.log(userDataCategory);
//console.log(userDataCategory[0]);
//console.log(Object.values(userDataCategory[0]));
console.log(Object.values(postBody)[0]);
    ...
    var params = {
        ...
        /* required */
        //FilterExpression: userDataCategory[0],
        //ProjectionExpression: userDataCategory[0],
        ProjectionExpression: Object.values(postBody)[0],
        //FilterExpression: Object.values(postBody)[0]
    };
