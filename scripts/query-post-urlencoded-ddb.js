...
app.post('/api/data', (request, response) => {
    ...
    var params = {
        ...
        KeyConditionExpression: "ssn = :blah",
        ExpressionAttributeValues: {
            ":blah": {
                'S': Object.values(postBody)[0] //need to extract the equivalent of {Item : { ssn: {'S': Object.values(postBody)[0][20]} }}
                //from app.post method in form-post-urlencoded-ddb.js,
                //presumably through some kind of app.post method in this file...
            }
        },
    };
